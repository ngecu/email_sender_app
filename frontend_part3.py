...
save_btn = Button(compose_frame,text="Save ♥",command=lambda : save_to_draft(email_value.get().lower(),subject_value.get(),compose_field.get("1.0",END)), relief=FLAT,bg="#737373",fg="white",font = ('courier', 30, 'bold') )
